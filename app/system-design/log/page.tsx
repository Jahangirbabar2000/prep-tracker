...
export default function SystemDesignLogPage() {
  return (
    <div className="max-w-2xl">
      <EscapeBack href="/system-design" />
      <Link href="/system-design" className="inline-flex items-center gap-1 text-xs text-muted hover:text-fg mb-4 transition-colors">
        <ArrowLeft size={13} /> System Design <span className="opacity-40 font-normal text-[10px] ml-0.5">Esc</span>
      </Link>
      <h1 className="text-2xl font-semibold text-fg tracking-tight mb-6">Log System Design Question</h1>
      <SystemDesignLogForm />
    </div>
  );
}
