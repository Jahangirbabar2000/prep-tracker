  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-5">
        ...
        <Link href="/ai/log" className="hidden md:inline-flex items-center gap-1.5 px-4 py-2 bg-accent text-accent-fg text-sm font-semibold rounded-lg hover:bg-accent-hover transition-colors cursor-pointer">
